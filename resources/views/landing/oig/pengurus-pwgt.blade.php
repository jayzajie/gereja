    ...
    <div class="pengurus-header">
        ...
        @if($pengurus->count() > 0)
            <div class="section-header">
                <div class="section-title">Pengurus PWGT Periode {{ $pengurus->first()->periode_mulai }} - {{ $pengurus->first()->periode_selesai }}</div>
            </div>
        ...
        @else
            <div class="section-header">
                <div class="section-title">Pengurus PWGT</div>

...
@section('title', 'Pengurus PKBGT - Gereja Toraja Eben-Haezer Selili')
...
@section('content')
    <div class="pengurus-header">
        <div class="pengurus-container">
            <h1 class="pengurus-title">Pengurus PKBGT Periode Tahun 2025</h1>
        </div>
    </div>
    ...
    <div class="pengurus-container">
        @if($pengurus->count() > 0)
            <div class="section-header">
                <div class="section-title">Pengurus PKBGT Periode {{ $pengurus->first()->periode_mulai }} - {{ $pengurus->first()->periode_selesai }}</div>
            </div>
        ...
        @else
            <div class="section-header">
                <div class="section-title">Pengurus PKBGT</div>

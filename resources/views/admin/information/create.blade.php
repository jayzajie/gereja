...
@section('title', 'Tambah Kegiatan Jemaat')
    ...
    <div class="form-container">
        ...
        <div class="form-body">
            <form action="{{ route('information.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <!-- Hidden fields untuk kategori, subcategory, dan priority dengan nilai default -->
                <input type="hidden" name="category" value="kegiatan">
                <input type="hidden" name="subcategory" value="special">
                ...
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                        ...
                        @foreach($statuses as $key => $label)
                            <option value="{{ $key }}" {{ old('status', 'published') === $key ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="d-flex gap-2 justify-content-end">
                    <a href="{{ route('information.index') }}" class="btn-cancel">Batal</a>

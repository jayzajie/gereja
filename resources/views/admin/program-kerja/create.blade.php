...
<div class="container-fluid">
    <div class="form-container">
        ...
        <div class="form-header">
            <h5>Tambah Program Kerja Baru</h5>
            ...
            <div class="form-content">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('komisi') is-invalid @enderror"
                               id="komisi" name="komisi" value="{{ old('komisi') }}"
                ...
                <div class="form-group full-width">
                    ...
                    <textarea class="form-control @error('content') is-invalid @enderror"
                              ...
                              placeholder="Masukkan deskripsi lengkap program kerja...">{{ old('content') }}</textarea>
                    @error('content')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        if (fileInput) {
            fileInput.addEventListener('change', function() {
                if (this.files && this.files[0]) {
                    ...
                    fileInputText.textContent = 'Pilih gambar...';
                }
            });
        }
    });

...
@section('title', 'PPGT - Persekutuan Kaum Bapak Gereja Toraja')
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-1">👨‍👩‍👧‍👦 PPGT - Persekutuan Pemuda Gereja Toraja</h4>
                    <p class="text-muted mb-0">Kelola data pengurus, program kerja, dan kegiatan PPGT</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="mb-0">Form Data Pengurus PPGT</h6>
                                    </div>
                                    <div class="card-body">
                                        <form action="{{ route('admin.oig.pengurus.store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="organisasi" value="PPGT">
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">Data Pengurus PPGT</h6>
                    ...
                    <div class="tab-pane fade" id="program-kerja-tab" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="mb-0">Form Program Kerja PPGT</h6>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">Data Program Kerja PPGT</h6>
                                        <button class="btn btn-success btn-sm">
                                            <i class="bx bx-export me-1"></i>Export
                                        </button>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="kegiatan-tab" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="mb-0">Form Kegiatan PPGT</h6>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">Data Kegiatan PPGT</h6>
                                        <button class="btn btn-success btn-sm">
                                            <i class="bx bx-export me-1"></i>Export
                                        </button>
                                    </div>

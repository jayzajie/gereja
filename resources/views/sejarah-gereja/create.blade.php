...
@section('title', 'Tambah Sejarah Gereja Toraja')
...
<div class="container-fluid">
    <div class="form-container">
        ...
        <div class="form-header">
            <h5>📜 Tambah Sejarah Gereja Toraja</h5>
            <a href="{{ route('sejarah-gereja.index') }}" class="btn-back">
        ...
        <!-- Form Body -->
        <form action="{{ route('sejarah-gereja.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror"
                           value="{{ old('title', 'Sejarah Gereja Toraja') }}" placeholder="Contoh: Sejarah Gereja Toraja">
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <textarea id="content" name="content" class="form-control large-textarea @error('content') is-invalid @enderror"
                              placeholder="Masukkan konten sejarah Gereja Toraja secara lengkap...">{{ old('content') }}</textarea>
                    @error('content')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-row">
                    ...
                    <!-- 
                    <div class="form-group">
                        <label for="banner_image">Banner/Foto Gereja</label>
                        <div class="file-input-wrapper">
            ...
            <div class="form-actions">
                ...
                <div class="btn-group">
                    <a href="{{ route('sejarah-gereja.index') }}" class="btn-secondary">Batal</a>

...
@section('title', 'Kelola Sejarah Gereja Toraja')
...
<div class="container-fluid">
    <div class="form-container">
        ...
        <div class="form-header">
            <h5>📜 Kelola Sejarah Gereja Toraja</h5>
            <a href="{{ route('sejarah-gereja.create') }}" class="btn-add">
        ...
        <div class="table-container">
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        @forelse($sejarahGerejas as $index => $sejarah)
                        <tr>
                            <td>{{ ($sejarahGerejas->currentPage() - 1) * $sejarahGerejas->perPage() + $index + 1 }}</td>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <!-- View Button -->
                                    <a href="{{ route('sejarah-gereja.show', $sejarah) }}"
                                    ...
                                    <!-- Edit Button -->
                                    <a href="{{ route('sejarah-gereja.edit', $sejarah) }}"
                                    ...
                                    <form action="{{ route('sejarah-gereja.toggle-status', $sejarah) }}"
                                    ...
                                    <!-- Delete Button -->
                                    <form action="{{ route('sejarah-gereja.destroy', $sejarah) }}"
                                          method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-4">
                                <div class="text-muted">
                                    ...
                                    Belum ada data sejarah gereja.
                                    <a href="{{ route('sejarah-gereja.create') }}" class="text-primary">Tambah sekarang</a>
                                </div>
                            </td>
                        </tr>
                        @endforelse
        ...
        <!-- Pagination -->
        @if($sejarahGerejas->hasPages())
            <div class="pagination-wrapper">
                {{ $sejarahGerejas->links() }}
            </div>
        @endif
    </div>
</div>

    ...
    <div class="row mb-4">
        <div class="col-12">
            <h4 class="fw-bold py-3 mb-2" style="color: #8B4513;">
                <span class="text-muted fw-light">Manajemen / Informasi /</span> Edit
            </h4>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('information.show', $information) }}" class="btn btn-outline-info btn-sm">
            ...
            <form action="{{ route('information.update', $information) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror"
                                      id="content" name="content" rows="10" required>{{ old('content', $information->content) }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('excerpt') is-invalid @enderror"
                                      ...
                                      placeholder="Ringkasan singkat (opsional, akan otomatis diambil dari konten jika kosong)">{{ old('excerpt', $information->excerpt) }}</textarea>
                            @error('excerpt')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div id="event-details" style="display: {{ $information->category == 'kegiatan' ? 'block' : 'none' }};">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="event_date" class="form-label">Tanggal Acara</label>
                                        <input type="date" class="form-control @error('event_date') is-invalid @enderror"
                                               id="event_date" name="event_date" value="{{ old('event_date', $information->event_date?->format('Y-m-d')) }}">
                                        @error('event_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('location') is-invalid @enderror"
                                               id="location" name="location" value="{{ old('location', $information->location) }}">
                                        @error('location')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('category') is-invalid @enderror"
                                ...
                                @foreach($categories as $key => $value)
                                    <option value="{{ $key }}" {{ old('category', $information->category) == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <!-- Subcategory -->
                        <div class="mb-3" id="subcategory-container" style="display: {{ $information->category ? 'block' : 'none' }};">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('author') is-invalid @enderror"
                                   id="author" name="author" value="{{ old('author', $information->author) }}">
                            @error('author')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('publish_date') is-invalid @enderror"
                                   id="publish_date" name="publish_date" value="{{ old('publish_date', $information->publish_date->format('Y-m-d')) }}" required>
                            @error('publish_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('priority') is-invalid @enderror"
                                   id="priority" name="priority" value="{{ old('priority', $information->priority) }}" min="0" max="100">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured"
                                       {{ old('is_featured', $information->is_featured) ? 'checked' : '' }}>
                        ...
                        @if($information->image)
                            <div class="mb-3">
                                ...
                                <div>
                                    <img src="{{ $information->image_url }}" alt="Current Image" class="img-fluid rounded" style="max-height: 200px;">
                                </div>
                            </div>
                        @endif
                        ...
                        <!-- Image -->
                        <div class="mb-3">
                            <label for="image" class="form-label">{{ $information->image ? 'Ganti Gambar' : 'Gambar' }}</label>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('information.show', $information) }}" class="btn btn-outline-info">
                                <i class="bx bx-show me-1"></i>Lihat
                            </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const currentSubcategory = '{{ old("subcategory", $information->subcategory) }}';
